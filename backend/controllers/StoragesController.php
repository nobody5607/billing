...
use backend\models\search\Storages as StoragesSearch;
...
/**
 * StoragesController implements the CRUD actions for Storages model.
 */
...
/*	    'access' => [
    ...
    /**
     * Lists all Storages models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new StoragesSearch();
    ...
    /**
     * Displays a single Storages model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing Storages model.
    ...
    /**
     * Deletes an existing Storages model.
    ...
    /**
     * Finds the Storages model based on its primary key value.
    ...
    {
        if (($model = Storages::findOne($id)) !== null) {
            return $model;
        } else {
