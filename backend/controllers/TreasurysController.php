...
use backend\models\search\Treasurys as TreasurysSearch;
...
/**
 * TreasurysController implements the CRUD actions for Treasurys model.
 */
...
/*	    'access' => [
    ...
    /**
     * Lists all Treasurys models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new TreasurysSearch();
    ...
    /**
     * Displays a single Treasurys model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Updates an existing Treasurys model.
    ...
    /**
     * Deletes an existing Treasurys model.
    ...
    /**
     * Finds the Treasurys model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return Treasurys the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = Treasurys::findOne($id)) !== null) {
            return $model;
        } else {
