    ...
    <div class="col-md-9">
        <div class="panel panel-default">
            ...
            <div class="panel-body">
                ...
                <div class="form-group field-settings-form-email required has-success">
                    <label class="col-lg-3 control-label" for="settings-form-email"><?= Yii::t('user','Email')?></label>
                    <div class="col-lg-9">
                        <?= $model->email; ?>
                    </div>
                ...
                <div class="form-group field-settings-form-email required has-success">
                    <label class="col-lg-3 control-label" for="settings-form-email"><?= Yii::t('user','Username')?></label>
                    <div class="col-lg-9">
                        <?= $model->username; ?>
                    </div>
                    <div class="col-sm-offset-3 col-lg-9"><div class="help-block"></div>
