...
use Yii;
use backend\models\BillStatus;
use backend\models\search\BillStatus as BillStatusSearch;
...
/**
 * BillStatusController implements the CRUD actions for BillStatus model.
 */
...
/*	    'access' => [
    ...
    /**
     * Lists all BillStatus models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new BillStatusSearch();
    ...
    /**
     * Displays a single BillStatus model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new BillStatus model.
    ...
    /**
     * Updates an existing BillStatus model.
    ...
    /**
     * Deletes an existing BillStatus model.
    ...
    /**
     * Finds the BillStatus model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return BillStatus the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = BillStatus::findOne($id)) !== null) {
            return $model;
        } else {
