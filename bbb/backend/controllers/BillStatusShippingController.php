...
use Yii;
use backend\models\BillStatusShipping;
use backend\models\search\BillStatusShipping as BillStatusShippingSearch;
...
/**
 * BillStatusShippingController implements the CRUD actions for BillStatusShipping model.
 */
class BillStatusShippingController extends Controller
{
...
/*	    'access' => [
    ...
    /**
     * Lists all BillStatusShipping models.
     * @return mixed
     */
    public function actionIndex()
    {
        $searchModel = new BillStatusShippingSearch();
    ...
    /**
     * Displays a single BillStatusShipping model.
     * @param integer $id
     * @return mixed
     */
    ...
    /**
     * Creates a new BillStatusShipping model.
    ...
    /**
     * Updates an existing BillStatusShipping model.
    ...
    /**
     * Deletes an existing BillStatusShipping model.
    ...
    /**
     * Finds the BillStatusShipping model based on its primary key value.
     * If the model is not found, a 404 HTTP exception will be thrown.
     * @param integer $id
     * @return BillStatusShipping the loaded model
     * @throws NotFoundHttpException if the model cannot be found
     */
    protected function findModel($id)
    {
        if (($model = BillStatusShipping::findOne($id)) !== null) {
            return $model;
        } else {
