...
$this->title = Yii::t('bill', 'Shipping');
                        ...
                        [
                            ...
                            [
                                ...
                                [
                                  ...
                                  'value'=>function($model){
                                    return Html::a('จัดการบิล <i class="fa fa-arrow-right" aria-hidden="true"></i> ',['/bill-shippings/manage?bill_id='.$model->id], ['class'=>'btn btn-primary btn-xs']);
                                  }
                                ],
                    // 'remark',
                    ],
